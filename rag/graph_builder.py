...
def build_graph(llm, stock_tools ,stock_assistant_runnable,rag_assistant_runnable,rag_tools):
    ...
    builder.add_node("rag_assistant",rag_assistant(rag_assistant_runnable))
